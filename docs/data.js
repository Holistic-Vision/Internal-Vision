/* data.js — Plan “terrain + testostérone” sur 4 semaines
   Notes:
   - Ce plan est orienté “insuline basse / inflammation basse / protéines suffisantes / graisses utiles”.
   - Ajuste les quantités selon faim, activité, perte de poids et récupération.
*/
...
window.IV_DATA = {
  ...
  pillars: [
    {
      id: "p1",
      title: "Insuline basse (ventre ↓, T ↑)",
      points: [
        "Petit-déj protéiné / gras, pas sucré.",
        "Féculents concentrés uniquement si tu en as besoin (activité) et plutôt à midi.",
        "Éviter grignotage tardif."
      ]
    },
    {
      id: "p2",
      title: "Inflammation basse (prostate/foie/hormones)",
      points: [
    ...
    {
      id: "p3",
      title: "Cholestérol suffisant (stéroïdes)",
      points: [
  ...
  goldenMilk: {
    ...
    cautions: [
      "Curcuma/gingembre peuvent irriter estomac chez certains: commencer demi-dose.",
      "Poivre + reflux: réduire/retirer.",
      "Anticoagulants/antiagrégants: prudence (avis médical)."
    ],
    mtc: [
      "Vision MTC: réchauffe le foyer inférieur, mobilise stagnations, soutient ‘Yang du Rein’ (si vide-froid).",
      "Si signes de chaleur (bouffées, irritabilité, reflux, langue rouge): diminuer gingembre/poivre, privilégier version plus douce."
    ],
    ayurveda: [
      "Approche ayurvédique: boisson ‘réchauffante’ utile si Kapha/Vata dominants.",
  ...
  weeks: [
    {
      week: 1,
      name: "Reset (insuline & inflammation)",
      focus: [
        "Zéro sucre ajouté",
        "Dîner léger chaud",
        "Marche quotidienne",
        "2–3 éjaculations/semaine max"
      ],
      days: []
    },
    {
      week: 2,
      name: "Densité (protéines + graisses utiles)",
      focus: [
        "Protéines à chaque repas",
        "Œufs quasi quotidiens",
        "Féculents ciblés (si besoin) le midi"
      ],
      days: []
    },
    {
      week: 3,
      name: "Performance (force + sommeil)",
      focus: [
        "2–4 mini séances force/semaine",
        "Sommeil + routine d’endormissement",
        "Golden milk stable"
      ],
      days: []
    },
    {
      week: 4,
      name: "Stabilisation (autonomie & variété)",
      focus: [
        "Varier recettes sans casser les règles",
        "Suivi précis (poids/tour de taille/énergie)",
        "Plan de maintien"
      ],
      days: []
    }
  ...
  // Gabarits repas (tu peux mixer selon ce que tu as)
  mealTemplates: {
    breakfast: [
      ...
      { id:"b3", name:"Fromage blanc (si toléré) + noix + cannelle", tags:["Option"], notes:"Si objectif strict: garder portion modérée." }
    ],
    lunch: [
  ...
  recipes: [
    {
      id:"r_omelette_pro",
      title:"Omelette ‘T+’ (anti-inflammation)",
      timeMin: 12,
      servings: 1,
      ingredients: [
        "3–4 œufs",
        "1 oignon (ou échalote)",
        "1 poignée épinards (ou courgette)",
        "Beurre ou huile d’olive",
        "Curcuma + poivre (option)",
        "Sel"
      ],
      steps: [
        "Faire revenir oignon + légumes 4–5 min.",
        "Battre les œufs, ajouter sel et curcuma (option).",
        "Cuire à feu moyen doux, baveuse ou ferme selon préférence."
      ],
      benefits: [
        "Protéines + lipides → support hormonal",
        "Oignon/ail: soutien métabolique",
        "Curcuma: terrain anti-inflammatoire (si toléré)"
      ],
      cautions: [
        "Si reflux: éviter poivre/épices le matin."
      ],
      mtc: [
        "Tiède/chaud, utile si ‘froid’ au foyer inférieur."
      ],
      ayurveda: [
        "Bon pour Kapha/Vata. Si Pitta: réduire épices."
      ]
    },
    {
      id:"r_soupe_soir",
      title:"Soupe du soir (sommeil & reins)",
      timeMin: 20,
      servings: 2,
      ingredients: [
        "Courgettes ou poireaux",
        "1 pomme de terre (option, petite)",
        "Bouillon / eau",
        "Huile d’olive",
        "Sel"
      ],
      steps: [
        "Cuire 15–18 min, mixer.",
        "Ajouter huile d’olive à la fin.",
        "Servir chaud, dîner léger."
      ],
      benefits: [
        "Dîner léger → sommeil plus profond",
        "Chaud → meilleur confort digestif"
      ],
      cautions: [
        "Éviter gros bol + dessert sucré."
      ],
    ...
    {
      id:"r_graines_courge",
      title:"Snack zinc (graines de courge + noix)",
      timeMin: 2,
      servings: 1,
      ingredients: [
        "Graines de courge 20–30 g",
        "Noix 15–20 g",
        "Cannelle (option)"
      ],
      steps: [
        "Mélanger. Collation si faim réelle (pas automatisme)."
      ],
      benefits: [
        "Zinc + bons lipides",
        "Satiété, soutien testostérone"
      ],
...
// Remplissage automatique des 28 jours à partir de templates
(function buildDays(){
  ...
  const mkDay = (week, dayIndex) => {
    ...
    // force 3–4 séances/sem à partir de la semaine 3
    ...
    return {
      ...
      training: {
        ...
        plan: strength
          ? [
              "6 min échauffement (mobilité + respiration)",
              "12–18 min force (voir minuterie)",
              "2 min retour au calme"
            ]
          : ["Respiration lente 5 min (option)"]
      },
      sex: {
        guideline: "Éjaculation 2–3x/semaine max (choisie). Orgasme sans éjac possible.",
      },
      habits
    };
  };
  ...
  weeks.forEach((w, wi)=>{
    w.days = Array.from({length:7}, (_,i)=> mkDay(w.week, i));
  });
})();
